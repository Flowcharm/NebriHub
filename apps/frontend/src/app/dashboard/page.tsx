        ...
        <nav className="flex flex-col items-center gap-4 px-2 sm:py-4">
          <Link href="/dashboard">
            <div className={`group flex h-9 w-9 shrink-0 items-center justify-center gap-2 rounded-lg text-lg font-semibold md:h-8 md:w-8 md:text-base ${pathName === '/dashboard' ? 'bg-primary text-primary-foreground' : 'text-muted-foreground transition-colors hover:text-foreground'}`}>
              <Home className={`h-4 w-4 transition-all group-hover:scale-110 ${pathName === '/dashboard' ? 'text-primary-foreground' : ''}`} />
                    ...
                    <AlertDialogDescription>
                      ...
                      <Select>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value={" "}>Antonio Cardador</SelectItem>
                          <SelectItem value={" "}>Elvira Hernández</SelectItem>
                        </SelectContent>
                      </Select>
                    </AlertDialogDescription>
                  </AlertDialogHeader>
